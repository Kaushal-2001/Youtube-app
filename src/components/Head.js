    ...
    <div className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-4 h-14 bg-[#0f0f0f]">
      ...
      <div className="flex items-center gap-4">
        <button
          ...
          className="w-10 h-10 flex items-center justify-center rounded-full hover:bg-[#272727] transition-colors"
        >
          <svg
            viewBox="0 0 24 24"
        ...
        <Link to="/" className="flex items-center gap-1">
          ...
          <span className="text-[10px] font-medium bg-[#272727] px-1 py-0.5 rounded">Premium</span>
        </Link>
      </div>
      ...
      <div className="flex items-center flex-1 max-w-[600px] mx-10">
        ...
        <input
          ...
          />
          <button className="w-16 h-10 flex items-center justify-center bg-[#222] border border-l-0 border-[#303030] rounded-r-full hover:bg-[#2a2a2a] transition-colors">
        ...
        <button className="w-10 h-10 ml-2 flex items-center justify-center bg-[#181818] rounded-full hover:bg-[#272727] transition-colors">
          <svg viewBox="0 0 24 24" className="w-6 h-6 fill-white">
      ...
      <div className="flex items-center gap-2">
        <button className="w-10 h-10 flex items-center justify-center rounded-full hover:bg-[#272727] transition-colors">
          <svg viewBox="0 0 24 24" className="w-6 h-6 fill-white">
            <path d="M17 10.5V7c0-.55-.45-1-1-1H4c-.55 0-1 .45-1 1v10c0 .55.45 1 1 1h12c.55 0 1-.45 1-1v-3.5l4 4v-11l-4 4z" />
          </svg>
        </button>
        <button className="w-10 h-10 flex items-center justify-center rounded-full hover:bg-[#272727] transition-colors relative">
          <svg viewBox="0 0 24 24" className="w-6 h-6 fill-white">
            <path d="M12,2C6.48,2,2,6.48,2,12s4.48,10,10,10s10-4.48,10-10S17.52,2,12,2z M12,20c-4.41,0-8-3.59-8-8s3.59-8,8-8s8,3.59,8,8 S16.41,20,12,20z M10.5,16.5l6-4.5l-6-4.5V16.5z" />
          </svg>
        </button>
        <button className="w-10 h-10 flex items-center justify-center rounded-full hover:bg-[#272727] transition-colors relative">
          <svg viewBox="0 0 24 24" className="w-6 h-6 fill-white">
        ...
        <button className="w-8 h-8 flex items-center justify-center rounded-full bg-[#ff6b35] text-white font-medium text-sm hover:bg-[#ff7f50] transition-colors">
          K
        </button>
      </div>
    </div>
